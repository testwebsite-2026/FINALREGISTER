...
(function (root) {
  ...
  function draw(canvas, opts) {
    ...
    return loadBackground().then(function (bg) {
      ...
      // title
      var tSize = fit(ctx, 'CERTIFICATE OF PARTICIPATION', 'italic bold', 1300, 96, 40);
      gradientText(ctx, 'CERTIFICATE OF PARTICIPATION', cx, 372, tSize, '#b5cc3c', C.mossDeep, true);
      flourish(ctx, cx, 431);
